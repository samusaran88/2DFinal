...
public:
	...
	HRESULT initTrans(int width, int height, BOOL trans = FALSE, COLORREF transColor = RGB(255, 0, 255), BOOL alphablend = FALSE);
	//파일로부터 이미지 초기화
	...
	void enlargeFrameRender(HDC hdc, int destX, int destY, int currentFrameX, int currentFrameY, float multiRate);
